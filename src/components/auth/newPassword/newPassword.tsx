...
import NewPasswordSvg from '@/../public/assets/authSvgs/newPasswordSvg.svg'
    ...
    return ( 
        ...
        <div className="flex justify-center h-[90%] w-[95%] rounded-3xl bg-white dark:bg-primaryDark2">
            <div className="flex flex-col gap-12 w-1/2 justify-center pr-24">
                ...
                <h1 className='font-bold text-5xl text-black dark:text-primaryYellow'>تنظیم <span className='text-primary'>رمزعبور </span> جدید</h1>
                </div>
            <NewPasswordForm/>
            </div>
            <div className="w-1/2 flex items-center justify-center bg-bgLoginSignup rounded-l-3xl dark:bg-primaryDark">
            <Image src={NewPasswordSvg} alt="svg" className="" />
            </div>
        </div>
        </div>
